...
<div class="relative bg-black pt-16 pb-20 px-4 sm:px-6 lg:pt-24 lg:pb-28 lg:px-8">
    ...
    <div class="relative max-w-7xl mx-auto">
        <div class="text-center">
            <h2 class="text-3xl tracking-tight font-extrabold text-gray-50 sm:text-4xl">Интересные статьи блога</h2>
            <p class="mt-3 max-w-2xl mx-auto text-xl text-gray-200 sm:mt-4">Если вам интересно почитать посты блога на тему наших услуг</p>
        </div>
